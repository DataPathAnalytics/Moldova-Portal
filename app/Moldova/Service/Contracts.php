...
class Contracts
{
 ...
 /**
     * @return array
     */
    public function getContractsBySource($sourceDistinct)
    {
        return $this->filterBySource($this->contracts->getContractsBySource(), $sourceDistinct);
    ...
    {
        return $this->contracts->getDistinctContractorsEtenderCount();
    }
